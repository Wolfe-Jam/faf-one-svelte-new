...
<footer class="footer" id="footer">
	<div class="container">
		<p class="tagline">The Context Standard for AI</p>

		<nav class="footer-nav" aria-label="Site footer">
		...
		<p class="copy">
			© {currentYear} FAF ·
			<a href="https://orcid.org/0009-0007-0801-3841" target="_blank" rel="noopener noreferrer">
				James Wolfe (ORCID)
			</a>
		</p>
	</div>
...
<style>
	/* LOCKED-DARK — footer always contrasts the page, regardless of theme toggle.
	   Use --faf-locked-* (constant; does not flip in [data-theme="dark"]). */
	.footer {
