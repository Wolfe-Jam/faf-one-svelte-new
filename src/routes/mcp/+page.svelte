...
<svelte:head>
	...
	<meta name="description" content="Official MCP documentation for .faf format. Universal AI context for Cursor, Windsurf, Cline, VS Code, and all MCP-compatible platforms. 30K+ downloads." />
</svelte:head>
...
<div class="mcp-page">
	...
	<section class="hero-section">
		<div class="container">
			...
			<p class="subtitle">Universal AI Context • IANA-Registered Format • 30K+ Downloads</p>
