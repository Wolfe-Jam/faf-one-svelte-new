	...
	<article class="post-content">
		...
		<section class="what-this-means">
			...
			<div class="code-block">
				<pre><code>claude plugin add github:Wolfe-Jam/faf-cli</code></pre>
			</div>
			<p>
				Or use the workaround if you hit the SSH bug:
			</p>
			<div class="code-block">
				<pre><code>npx faf-cli plugin-install Wolfe-Jam/faf-cli</code></pre>
			</div>
		</section>
...
faf init
faf plugin-install Wolfe-Jam/faf-cli</code></pre>
			</div>
		</section>
